...
function Cards(index,product) {
  return (
    ...
    >
      {product.isNew && (
        <span className="absolute top-0 right-0 px-2 py-1 text-white bg-red-500 rounded-tr-lg">
          New
        </span>
      )}
      <div
      ...
      <div className="flex justify-between mt-4">
        ...
        <button className="flex items-center gap-2 px-4 py-2 text-white bg-red-500 rounded-lg">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
            width="20"
