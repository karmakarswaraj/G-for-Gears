            ...
            <div className="flex-auto px-4 py-10 pt-0 lg:px-10">
              ...
              <form className="my-5" onSubmit={handleSubmit}>
                ...
                <div className="mt-6 text-center">
                  <button
                    className="w-full px-6 py-3 mb-1 mr-1 text-sm font-bold text-white uppercase bg-gray-900 rounded shadow outline-none active:bg-gray-700 hover:shadow-lg focus:outline-none hover:bg-red-700"
                    type="submit"
                    style={{ transition: "all .15s ease" }}
                  >
                    Log In
